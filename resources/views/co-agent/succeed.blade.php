                                ...
                                <a href="{{ url('get-detall', $member->id) }}">
                                    <div class="card-new">
                                        ...
                                        <div class="box-width-rent-sell">
                                            ...
                                            @if ($member->rent == 'เช่า')
                                                <span
                                                    class="rent-sell-primary absolute-rent-sell">{{ $member->rent }}</span>
                                            @endif

                                            @if ($member->sell == 'ขาย')
                                                <span
                                                    class="rent-sell-yellow absolute-rent-sell">{{ $member->sell }}</span>
                                            @endif
