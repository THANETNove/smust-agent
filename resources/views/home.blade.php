                                ...
                                <div class="card-new">
                                    ...
                                    <div class="box-width-rent-sell">
                                        ...
                                        @elseif ($home2->rent_sell == 'เช่า/ขาย' || $home2->rent_sell == 'เช่าซื้อ/ขายผ่อน')
                                            <span class="rent-sell-green absolute-rent-sell">{{ $home2->rent_sell }}</span>
                                        @endif

                                        @if ($home2->rent == 'เช่า')
                                            <span class="rent-sell-primary absolute-rent-sell">{{ $home2->rent }}</span>
                                        @endif

                                        @if ($home2->sell == 'ขาย')
                                            <span class="rent-sell-yellow absolute-rent-sell">{{ $home2->sell }}</span>
                                        @endif
